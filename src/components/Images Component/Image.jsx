...
const Image = () => {
  ...
  const fectchImages = async () => {
    const inputValue = "beach,girl,cars,money";
    const response = await fetch(
      `https://api.unsplash.com/search/photos?page=5&per_page=30&query=${inputValue}&client_id=EWsfGMpc4aQkeWq1mpoNwIy4onlIU_vA4kiaHaJxpAA`
    );
